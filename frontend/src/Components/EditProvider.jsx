  ...
  if (loadingData) {
    return (
      <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center">
        <Loader2 className="w-12 h-12 animate-spin text-[#f58d2f] mb-4" />
        <p className="text-slate-400 font-black uppercase tracking-widest text-[10px]">Sincronizando Perfil...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] p-6 sm:p-12 font-sans flex justify-center items-start">
      <div className="w-full max-w-7xl animate-in fade-in duration-500">
        ...
        {/* ENCABEZADO CON BOTÓN DE GUARDADO (Estilo Branding) */}
